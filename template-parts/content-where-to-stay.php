...
<div class="container p-3">
    <div class="row">
        <div class="col">
            <h4 class="text-center">Onde Ficar?</h4>
        </div>
    </div>
</div>
...
<section class="center slider">
    ...
    <div>
        <div class="card mb-3" style="width: 920px; height: 288px; background-color: #FFFFFF; border-radius: 8px; margin-left: -3%;">
            <div class="row g-0">
                <div class="col-md-7">
